    ...
    prompting() {
        ...
        const prompts = [{
            ...
            },
            {
                ...
                suffix: '(if you want to add more than one redirect uri, please, separate them by comma)',
                message: 'Enter your client(application) redirect uris, that handle authorization_code and make request to /auth/token ',
        ...
        return this.prompt(prompts).then(props => {
            ...
            this.redirectUris = props['authentication:redirect_uris'] ? props['authentication:redirect_uris'].split(',') : '';
